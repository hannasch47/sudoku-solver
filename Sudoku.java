...
public class Sudoku {    
    ...
    private boolean[][] valInRow; // will store if value in first bracket is in row in second bracket
    private boolean[][] valInCol; // will store if value in first bracket is in col in second bracket
    ...
    public Sudoku() {
        ...
        this.valInRow = new boolean[10][9]; // 10x9 so that we can store values 1-9 
        this.valInCol = new boolean[10][9];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.valInRow[val][row] = true;
        this.valInCol[val][col] = true;
    }
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.valInRow[val][row] = false;
        this.valInCol[val][col] = false; 
    ...
    private boolean isSafe(int row, int col, int val) {
        // returns true if the value is not already in row or column
        // AND if value is not already in subgrid
        if ((this.valInRow[val][row] == false) && 
            (this.valInCol[val][col] == false) && 
            (this.subgridHasVal[row/3][col/3][val] == false)) {
                return true;
            }
